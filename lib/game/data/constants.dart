...
String gdfsgdfs(String hrdsvfcsd, int dssadfasdfaer) {
    ...
    for (int i = 0; i < hrdsvfcsd.length; i++) {
      ...
      if (gsdffdsgdsghcdasjfjdsagchdasfjkdshcgfdjs >= 65 && gsdffdsgdsghcdasjfjdsagchdasfjkdshcgfdjs <= 90) {
        gsdffdsgdsghcdasjfjdsagchdasfjkdshcgfdjs = (gsdffdsgdsghcdasjfjdsagchdasfjkdshcgfdjs - 65 + dssadfasdfaer) % 26 + 65;
      } else if (gsdffdsgdsghcdasjfjdsagchdasfjkdshcgfdjs >= 97 && gsdffdsgdsghcdasjfjdsagchdasfjkdshcgfdjs <= 122) {
        gsdffdsgdsghcdasjfjdsagchdasfjkdshcgfdjs = (gsdffdsgdsghcdasjfjdsagchdasfjkdshcgfdjs - 97 + dssadfasdfaer) % 26 + 97;
      }
